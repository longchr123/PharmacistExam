...
import com.example.administrator.yaoshi.adapter.NewsListAdapter;
import com.example.administrator.yaoshi.bean.NewsItem;
...
public class NewsActivity extends AppCompatActivity implements XListView.IXListViewListener, View.OnClickListener {
    ...
    public void downData(final int pages) {
        String httpUrl = "http://www.zhongyuedu.com/api/tk_yao_newsList.php ";//公司服务器
