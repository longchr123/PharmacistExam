...
import com.example.administrator.yaoshi.adapter.AnswerVpAdapter;
import com.example.administrator.yaoshi.bean.TestItem;
import com.example.administrator.yaoshi.fragment.XiTiTestFragment;
...
// 分享时Notification的图标和文字  2.5.9以后的版本不调用此方法
        ...
        oks.setTitleUrl("http://android.myapp.com/myapp/detail.htm?apkName=com.zhongyuedu.yaoshi");
        // text是分享文本，所有平台都需要这个字段
        oks.setText(listItem.get(currentPosition - 1).get题干());
        // imagePath是图片的本地路径，Linked-In以外的平台都支持此参数
        //oks.setImagePath("/sdcard/test.jpg");//确保SDcard下面存在此张图片
        // url仅在微信（包括好友和朋友圈）中使用
        oks.setUrl("http://android.myapp.com/myapp/detail.htm?apkName=com.zhongyuedu.yaoshi");
        // comment是我对这条分享的评论，仅在人人网和QQ空间使用
        oks.setComment("我是测试评论文本");
        // site是分享此内容的网站名称，仅在QQ空间使用
        oks.setSite(getString(R.string.app_name));
        // siteUrl是分享此内容的网站地址，仅在QQ空间使用
        oks.setSiteUrl("http://android.myapp.com/myapp/detail.htm?apkName=com.zhongyuedu.yaoshi");
        // 启动分享GUI
        oks.show(this);
    }
}
